# ====================================================================================
# Setup Project
PROJECT_NAME := provider-azureextra
...
XPKGS = provider-azureextra
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-azureextra: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider AzureExtra CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider AzureExtra controllers
...
# This target prepares repo for your provider by replacing all "azureextra"
